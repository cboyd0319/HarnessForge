...
| --- | --- | --- | --- | --- |
| 2026-06-14 | Local unit tests | `PYTHONPATH=src:. python3 -m unittest discover -s tests` | pass | 36 tests after README-source parser and research-ledger additions. |
...
| 2026-06-14 | POSIX verification | `./init.sh` | pass | Doctor, compile, 36 tests, pin check, self-audit. |
| 2026-06-14 | PowerShell verification | `pwsh -NoProfile -File ./init.ps1` | pass | Doctor, compile, 36 tests, pin check, self-audit. |
