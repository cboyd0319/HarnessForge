...
| --- | --- | --- | --- | --- |
| 2026-06-14 | Local unit tests | `PYTHONPATH=src:. python3 -m unittest discover -s tests` | pass | 37 tests after README-source parser, research-ledger, and Action manifest additions. |
...
| 2026-06-14 | POSIX verification | `./init.sh` | pass | Doctor, compile, 37 tests, pin check, self-audit. |
| 2026-06-14 | PowerShell verification | `pwsh -NoProfile -File ./init.ps1` | pass | Doctor, compile, 37 tests, pin check, self-audit. |
