...
| Workflow surfaces | Maintainers | Keep the live scheduled self-heal/research workflow, generated optional workflow scaffolds, and published composite Action behavior separate. Live workflows may refresh HarnessForge research metadata. Generated workflow scaffolds are manual target-repo files by default. The published Action is input-driven and does not schedule, commit, push, or open pull requests. |
